...
namespace LeaveAppManagement.dataAccess.Interfaces
{
    public interface IUsersRepository
    {
        ...
        Task<IEnumerable<User>> GetUsersByRoleIdAsync(int roleId, CancellationToken cancellationToken);
        Task<User?> GetSingleManagerByRoleIdAsync(int roleId, CancellationToken cancellationToken);
